...
# основная программа
def migrate(name_db2, name_db1):
    open(f"{name_db2[:-3]}.sql", 'w').close()  # очистка перед записью
    ...
    mas_table_db2 = add_tables(mas_table_db1, mas_table_db2, cursor_db_2, name_db2)
    drop_tables(mas_table_db1, mas_table_db2, cursor_db_2, name_db2)

    update_columns(mas_table_db1, cursor_db_1, cursor_db_2, name_db2)
